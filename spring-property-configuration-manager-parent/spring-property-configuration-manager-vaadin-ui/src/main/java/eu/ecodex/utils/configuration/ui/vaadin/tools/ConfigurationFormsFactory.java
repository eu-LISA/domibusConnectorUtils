...
public interface ConfigurationFormsFactory {
    ...
    AbstractField createField(ConfigurationProperty configurationProperty,
                              Binder<Map<String, String>> binder);

    ConfigurationFormsFactoryImpl.ConfigurationPropertyForm createFormFromConfigurationPropertiesClass(
